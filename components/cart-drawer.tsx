...
export function CartDrawer() {
  ...
  return (
    <>
      {/* Backdrop */}
      <div className="fixed inset-0 z-[70] bg-black/60 backdrop-blur-sm" onClick={() => setIsCartOpen(false)} />
      ...
      <div className="fixed top-0 right-0 bottom-0 z-[80] w-full max-w-md bg-[#0d1f14] border-l border-[#b8860b]/10 flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-[#b8860b]/10">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-serif text-xl font-bold text-[#f5f0e1]">Your Cart</h2>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center">
              ...
              <p className="font-serif text-xl text-[#f5f0e1] mb-2">Your cart is empty</p>
              <p className="text-[#f5f0e1]/50 mb-8">Add some delicious items to get started</p>
              <Link
                href="/shop"
                onClick={() => setIsCartOpen(false)}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <span className="font-bold text-[#b8860b]">₹{item.product.price * item.quantity}</span>
                      ...
                      <div className="flex items-center gap-1 bg-[#0d1f14] rounded-full">
                        ...
                        <span className="w-6 text-center text-sm font-semibold text-[#f5f0e1]">{item.quantity}</span>
                        <button
                          onClick={() => updateQuantity(item.product.id, item.quantity + 1)}
                          className="w-7 h-7 flex items-center justify-center text-[#f5f0e1]/70 hover:text-[#b8860b] transition-colors"
                        >
          ...
          <div className="p-6 border-t border-[#b8860b]/10 space-y-4">
            ...
            {totalPrice < 500 && (
              <div className="p-3 bg-[#b8860b]/10 rounded-lg">
                <p className="text-sm text-[#b8860b]">Add ₹{500 - totalPrice} more for free delivery!</p>
