...
import { Playfair_Display, Inter, IBM_Plex_Mono, Libre_Baskerville as V0_Font_Libre_Baskerville, IBM_Plex_Mono as V0_Font_IBM_Plex_Mono, Lora as V0_Font_Lora } from 'next/font/google'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "From the kitchens of Madras to your table. Handcrafted podis, pickles, sweets & savouries.",
    type: "website",
  },
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body className={`${playfair.variable} ${inter.variable} ${ibmPlexMono.variable} font-sans antialiased`}>
