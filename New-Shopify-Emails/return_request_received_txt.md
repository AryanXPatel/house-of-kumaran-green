Return_Request_Received.txt
Email subject
Return requested for order {{ order.name }}
Email body (HTML)
<!DOCTYPE html>
<html lang="en">
    ...
    <td class="content__cell">
      <center>
        <table class="container">
          ...
          <h2>Your return request was sent</h2>
          <p class="return-requested__body">Your return request was sent and is being reviewed. We'll email you once it's been completed.</p>
  ...
  <tr>
    <td class="actions__cell">
      <table class="button main-action-cell">
        <tr>
          <td class="button__cell"><a href="{{ order_details_url }}" class="button__text">View your order</a></td>
        </tr>
      </table>
